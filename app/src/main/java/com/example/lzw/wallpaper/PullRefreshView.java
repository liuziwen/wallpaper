...
public class PullRefreshView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        setCacheColorHint(context.getResources().getColor(R.color.maincolor));
        inflater = LayoutInflater.from(context);
        headerView = (LinearLayout) inflater.inflate(R.layout.header, null);
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
                lvHeaderArrowIv.setImageResource(R.drawable.ic_file_download_black_36dp);
                lvHeaderTipsTv.setText("下拉刷新");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
